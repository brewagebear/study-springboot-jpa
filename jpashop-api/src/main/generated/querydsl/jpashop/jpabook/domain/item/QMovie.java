...
public class QMovie extends EntityPathBase<Movie> {
    ...
    private static final long serialVersionUID = -1919870120L;
    ...
    //inherited
    public final ListPath<jpashop.jpabook.domain.Category, jpashop.jpabook.domain.QCategory> categories = _super.categories;
