...
public class QMovie extends EntityPathBase<Movie> {
    ...
    private static final long serialVersionUID = 1664221893L;
    ...
    //inherited
    public final ListPath<jpashop.jpabook.section2.domain.Category, jpashop.jpabook.section2.domain.QCategory> categories = _super.categories;
